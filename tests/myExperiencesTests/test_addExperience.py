# Profil Bilgileri -> Deneyeimlerim Sayfası 
...
class TestAddExperience():
  ...
  def test_addExperience(self):
      ...
      corporationName =WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located((By.XPATH, "//div[@id='__next']/div/main/section/div/div/div[2]/form/div/div/input")))
